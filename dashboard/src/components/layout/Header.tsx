...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  const title = pageTitles[location.pathname] ?? "داشبورد";
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-1.5">
          ...
          <div className="hidden text-right sm:block">
            <p className="text-sm font-medium text-slate-700">دکتر احمدی</p>
            <p className="text-[10px] text-slate-400">ژنتیک بالینی</p>
          </div>
        </div>
      </div>
    </header>
